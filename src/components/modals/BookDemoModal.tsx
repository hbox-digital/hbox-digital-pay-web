          ...
          <div className="relative hidden md:flex md:w-[40%] bg-[url('https://cdn.hboxdigital.com/public/hbox-pay/video/6267593_Business_Pos_3840x2160.mp4')] bg-cover bg-center items-start justify-start p-8">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-[#8CEE54] rounded-md flex items-center justify-center">
                  <span className="text-black font-bold text-lg">H</span>
                </div>
                <span className="text-white font-semibold text-xl">HBOX Pay</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 p-6 sm:p-8 relative">
            ...
            <DialogHeader className="mb-6">
              <DialogTitle className="text-2xl sm:text-3xl font-normal text-left">
                Start the <span className="text-[#53B033] font-semibold">Conversation</span>
              </DialogTitle>
              <DialogDescription className="text-left text-sm text-gray-600 mt-2">
                We'll connect with you soon to schedule a meeting to discuss your goals.
              </DialogDescription>
            </DialogHeader>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-2">
                <Label htmlFor="message" className="text-sm text-gray-700">
                  Tell us how we can help you... <span className="text-red-500">*</span>
                </Label>
                <Textarea
                  id="message"
                  placeholder=""
              ...
              <div className="flex items-start space-x-3">
                ...
                <Label
                  htmlFor="consent"
                  className="text-xs text-gray-600 font-normal leading-relaxed cursor-pointer"
                >
                  By submitting this form, you agree to receive support and informational
                  text messages from HBOX Pay LLC at your number.
                  <br />
                  View our{" "}
                  <Link
                    href="/privacy-policy"
                    className="text-[#53B033] underline hover:text-[#469929]"
                  >
                    Privacy Policy
                  </Link>{" "}
                  &{" "}
